...
/// [`Report::frames()`]: error_stack::Report::frames
#[must_use]
#[derive(Clone)]
pub struct Frames<'r> {
...
///
/// [`Report`]: error_stack::Report
/// [`Report::frames_mut()`]: error_stack::Report::frames_mut
#[must_use]
...
///
/// [`Report`]: error_stack::Report
/// [`Report::request_ref()`]: error_stack::Report::request_ref
#[must_use]
#[cfg(nightly)]
...
///
/// [`Report`]: error_stack::Report
/// [`Report::request_value()`]: error_stack::Report::request_value
#[must_use]
#[cfg(nightly)]
